...
// "+ New list", "Manage lists") stays in ListSelector since it's also
// used by the desktop popover and doesn't depend on vaul; passed as
// children. Together with M11's useIsMobile gate, vaul never loads on
// desktop.
type Props = {
  open: boolean
